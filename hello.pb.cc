...
extern PROTOBUF_INTERNAL_EXPORT_hello_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_helloworld_PhoneNumber_hello_2eproto;
namespace lm {
class helloworld_PhoneNumberDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<helloworld_PhoneNumber> _instance;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_helloworld_hello_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_helloworld_hello_2eproto}, {
      &scc_info_helloworld_PhoneNumber_hello_2eproto.base,}};

static void InitDefaultsscc_info_helloworld_PhoneNumber_hello_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::lm::_helloworld_PhoneNumber_default_instance_;
    new (ptr) ::lm::helloworld_PhoneNumber();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::lm::helloworld_PhoneNumber::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_helloworld_PhoneNumber_hello_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_helloworld_PhoneNumber_hello_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_hello_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::lm::helloworld_PhoneNumber, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::lm::helloworld_PhoneNumber, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::lm::helloworld_PhoneNumber, number_),
  PROTOBUF_FIELD_OFFSET(::lm::helloworld_PhoneNumber, type_),
  0,
  1,
  ...
  PROTOBUF_FIELD_OFFSET(::lm::helloworld, phones_),
  1,
  0,
  ~0u,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::lm::helloworld_PhoneNumber)},
  { 9, 17, sizeof(::lm::helloworld)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::lm::_helloworld_PhoneNumber_default_instance_),
...
const char descriptor_table_protodef_hello_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013hello.proto\022\002lm\"\305\001\n\nhelloworld\022\n\n\002id\030\001"
  " \002(\005\022\013\n\003str\030\002 \001(\t\022*\n\006phones\030\004 \003(\0132\032.lm.h"
  "elloworld.PhoneNumber\032E\n\013PhoneNumber\022\016\n\006"
  "number\030\001 \001(\t\022&\n\004type\030\002 \001(\0162\030.lm.hellowor"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_hello_2eproto = {
  false, false, descriptor_table_protodef_hello_2eproto, "hello.proto", 217,
...
void helloworld_PhoneNumber::InitAsDefaultInstance() {
}
...
helloworld_PhoneNumber::helloworld_PhoneNumber(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:lm.helloworld.PhoneNumber)
}
helloworld_PhoneNumber::helloworld_PhoneNumber(const helloworld_PhoneNumber& from)
  ...
  type_ = from.type_;
  // @@protoc_insertion_point(copy_constructor:lm.helloworld.PhoneNumber)
}

void helloworld_PhoneNumber::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_helloworld_PhoneNumber_hello_2eproto.base);
  number_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  type_ = 0;
}

helloworld_PhoneNumber::~helloworld_PhoneNumber() {
  // @@protoc_insertion_point(destructor:lm.helloworld.PhoneNumber)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void helloworld_PhoneNumber::SharedDtor() {
...
const helloworld_PhoneNumber& helloworld_PhoneNumber::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_helloworld_PhoneNumber_hello_2eproto.base);
...
// @@protoc_insertion_point(message_clear_start:lm.helloworld.PhoneNumber)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "lm.helloworld.PhoneNumber.number");
          #endif  // !NDEBUG
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::lm::helloworld_PhoneType_IsValid(val))) {
            _internal_set_type(static_cast<::lm::helloworld_PhoneType>(val));
          } else {
...
::PROTOBUF_NAMESPACE_ID::uint8* helloworld_PhoneNumber::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:lm.helloworld.PhoneNumber)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "lm.helloworld.PhoneNumber.number");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lm.helloworld.PhoneNumber)
  return target;
}

size_t helloworld_PhoneNumber::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:lm.helloworld.PhoneNumber)
  size_t total_size = 0;
...
void helloworld_PhoneNumber::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:lm.helloworld.PhoneNumber)
  GOOGLE_DCHECK_NE(&from, this);
  const helloworld_PhoneNumber* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<helloworld_PhoneNumber>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:lm.helloworld.PhoneNumber)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:lm.helloworld.PhoneNumber)
    MergeFrom(*source);
  }
}

void helloworld_PhoneNumber::MergeFrom(const helloworld_PhoneNumber& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:lm.helloworld.PhoneNumber)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void helloworld_PhoneNumber::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:lm.helloworld.PhoneNumber)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:lm.helloworld.PhoneNumber)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::lm::helloworld_PhoneNumber* Arena::CreateMaybeMessage< ::lm::helloworld_PhoneNumber >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lm::helloworld_PhoneNumber >(arena);
}
